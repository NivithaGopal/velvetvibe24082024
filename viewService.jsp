...
<body>
    <div class="container">
        ...
        <a href="addService.jsp" class="btn btn-custom mb-3">Add New Service</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-icons">
                        <a href="editService.jsp?service_id=<%=service.getService_id()%>" title="Edit">
                            <i class="bi bi-pencil-square" style="color: #333;"></i>

                        </a>
                        <a href="deleteService.jsp?service_id=<%=service.getService_id()%>" title="Delete">
